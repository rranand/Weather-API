...
<?php
    if (!isset($_SESSION['ad_username'])) {
        ...
        $search = $_GET['search'];
        $db = new database();
        $log = new contact($db->Connect());
        if (isset($search) && strlen($search)>0) {
            $data = json_decode($log->search($search), true);
        } else {
            $data = json_decode($log->getDet(), true);
        }
    }
?>
<!DOCTYPE html>
      ...
      <div class="content">
        <div class="container-fluid">
          ...
          <form class="search-form">
                <input class="search" type="search" placeholder="Search by email..." name="search">
            </form>
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <?php
                    ...
                    <?php
                            ...
                            ?>
                                <h2 align="center"> No Queries From <b><?php echo $search; ?></b>!!! </h2>
                            <?php
                        } else {
                            ?>
                                <h2 align="center"> No Queries yet!!! </h2>
                            <?php
                        }
                     ?>
                  </div>
